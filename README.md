...
2. **Fit** — reads your CV **locally** and gives you an honest per-role gap analysis. Matches,
   missing, and partial — labelled separately. It will not oversell you into a role you will not get.
3. **Tailor** — writes a custom CV and cover letter for **one specific role**, truthful to what is
   actually in your CV, in the right shape (tabular Lebenslauf) — and **in German or English**,
   using a real decision rule rather than a guess.
4. **Prepare** — interview prep, and an offer check against German employment law: Probezeit,
...
- the **tabular Lebenslauf** (≤2 pages) and that the **photo is optional, not mandatory** — more
...
disclose the salary, it says so — it doesn't invent a range.

## What it will never do

- Auto-apply or mass-apply. Greenhouse, Workday and LinkedIn all contractually ban automated
  applications, and mass-applying gets people banned — and doesn't work.
